  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-center items-center bg-[var(--bg-primary)] text-[var(--text-primary)] overflow-hidden transition-colors duration-300">
      ...
      <div className="z-10 text-center px-6 max-w-4xl mx-auto">
        <p
          id="hello"
          className="text-[var(--text-secondary)] text-sm sm:text-base mb-6 tracking-[0.2em] uppercase font-medium animate-fade-in-up"
        >
          Hello,
        </p>
        ...
        <h1
          id="name"
          className="text-5xl sm:text-7xl md:text-g8xl font-extrabold tracking-tight mb-6 leading-tight"
        >
          I'm{" "}
        ...
        <p
          id="description"
          className="text-lg sm:text-2xl text-[var(--text-secondary)] mb-12 max-w-2xl mx-auto font-light leading-relaxed"
        >
